...
# data_samples = dataset.data[:n_samples]  # [u"first document entries", u"second document entries"]
...
ML.lda_visualize.visualize_lda(corpus=corpus_location, doc_topic_mat=_gamma, topic_word_mat=_lambda,
                               ...
                               output_file="/home/lt/Downloads/sklearn_lda_output.html")

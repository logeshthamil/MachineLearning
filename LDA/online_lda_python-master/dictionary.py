...
argparser.add_argument("-o", "--outfile", dest="outfile", default='vocab.txt',
                       help="Output filename. (default='vocab.txt')")
argparser.add_argument("-t", "--threshold", type=int, dest="threshold", default=20,
                       help="Word count threshold; excludes words below threshold. (default=20)")
args = argparser.parse_args()


def generate(f, outfile, t):
    print "Tokenizing file."
    toks = nltk.PunktSentenceTokenizer().tokenize(open(f).read())

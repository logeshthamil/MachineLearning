...
argparser.add_argument("-f", "--fields", dest="fields", default=['Title', 'Body', 'Tags'], nargs="+",
                       help="XML fields to parse.")
argparser.add_argument("-n", "--num_records", dest="num_records", type=int, default=27000000,
                       help="Approx # lines in xml_file.")
argparser.add_argument("-s", "--num_samples", dest="num_samples", type=int, default=-1,
                       help="Number of samples. If greater than zero, will sample file instead of parsing entire file.")
